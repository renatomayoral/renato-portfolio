...
export default function PortfolioCard(props: any) {
  return (
    <div
      key={props.id}
      className="justify-center text-center m-4 p bg-gray-200 rounded-md transition ease-in-out delay-150 hover:-translate-y-2 "
    >
          ...
          <div className="flex-col md:text-md max-w-md mx-auto text-start">
            ...
            <div className=" justify-start flex gap-4">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className=" flex justify-center bg-gradient-to-r from-cyan-600 to-teal-600 text-white px-4 py-2 rounded-md items-center"
              >
